...
This is a console-based **Student Information System** developed in Java using JDBC for MySQL integration. It supports basic CRUD (Create, Read, Update, Delete) operations on student records.
...
- MySQL Server
- MySQL JDBC Driver
- A database named `student_system` with a `students` table
- 
[Download MySQL JDBC Driver](https://drive.google.com/file/d/1U1RQgCWTRJ6K3jvygbAUDsahtPeUX2am/view?usp=sharing)


[Download the source code](https://drive.google.com/drive/folders/1CeH1DAMb6bJdWgAwpsbkstw1QjDem5IV?usp=sharing)
